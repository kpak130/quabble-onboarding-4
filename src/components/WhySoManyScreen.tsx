...
export function WhySoManyScreen({
  onBack,
  onNext
}: WhySoManyScreenProps) {
  useEffect(() => {
    // Function to be called when the component mounts
    sendToFlutter('{"event":"v2_5_7_onboarding_A::onboarding:why_so_many:landing"}');
  }, []); 
  ...
  return <>
    ...
    <div className="flex flex-col w-full min-h-screen bg-[#faf7f0] text-gray-800 relative">
      {/* Header - same position as ConfirmationScreen */}
        ...
        <div className="p-5 sm:p-6">
          <div className="max-w-md mx-auto">
            <button
              ...
              onClick={() => {
                sendToFlutter('{"event":"v2_5_7_onboarding_A::onboarding:why_so_many:click_next"}');
                onNext();
              }}
            >
              Next
